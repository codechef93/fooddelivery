...
class InProgressPager: ButtonBarPagerTabStripViewController {
    var isReload = false
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        var vcs = [INProgressOrdersController]()
        ...
        if (User.shared!.level == "level1")
        {
            ...
            let allOrdersVc : INProgressOrdersController = UIStoryboard(storyboard: .riders).instantiateViewController()
        ...
        else if (User.shared!.level == "level2")
        {
            ...
            cities!.forEach({
                 let orders : INProgressOrdersController = UIStoryboard(storyboard: .riders).instantiateViewController()
