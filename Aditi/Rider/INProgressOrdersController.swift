//
//  INProgressOrdersController.swift
//  AditiInternal
//
...
class INProgressOrdersController: UIViewController, IndicatorInfoProvider {
    ...
    func getOrders(){
        ...
        var query = ordersCol.whereField("driver.id", isEqualTo: User.shared?.id)
            .whereField("status", isEqualTo: OrderStatus.inprogress.rawValue)
...
extension INProgressOrdersController : UITableViewDataSource , UITableViewDelegate{
...
//        cell.acceptBtn.setTitle("細節", for: .normal)
        return cell
    }
...
extension INProgressOrdersController : OrderCellDelegate {
...
extension INProgressOrdersController : QrScannerVcDelegate {
...
extension INProgressOrdersController : DZNEmptyDataSetSource {
